...
import { Skeleton } from '@/components/ui/skeleton'; // Need to add skeleton if not present, or use custom loading
                    ...
                    <TableBody>
                        {transactions.length === 0 ? (
                            ...
                            transactions.map((transaction) => (
                                <TableRow
                                    key={transaction.id}
                                    data-state={selectedIds.includes(transaction.id) && "selected"}
                                >
                                    <TableCell>
                                        <Checkbox
